          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={name} className="space-y-1.5">
                <label className="text-[11px] font-semibold uppercase tracking-widest text-stone-400">{label}</label>
                <select
                  {...register(name)}
                  ...
                  onFocus={e => {
                    e.currentTarget.style.borderColor = errors[name] ? '#f43f5e' : '#6366f1'
                    e.currentTarget.style.boxShadow = errors[name] ? '0 0 0 3px rgba(244,63,94,0.1)' : '0 0 0 3px rgba(99,102,241,0.1)'
                    e.currentTarget.style.background = '#ffffff'
                  }}
                  onBlur={e => {
                    e.currentTarget.style.borderColor = errors[name] ? '#f43f5e' : '#e7e5e4'
                    e.currentTarget.style.boxShadow = 'none'
                    e.currentTarget.style.background = '#f8f7f4'
                  }}
                >
